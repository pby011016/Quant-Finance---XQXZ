...
df_big = pd.read_csv(r'D:\quantclass\大小盘风格轮动\data\跨境\sh513520.csv', encoding='gbk', parse_dates=['candle_end_time'])
df_small = pd.read_csv(r'D:\quantclass\大小盘风格轮动\data\跨境\sz159920.csv', encoding='gbk', parse_dates=['candle_end_time'])
...
df = df[df['candle_end_time'] >= '2010-06-02']
