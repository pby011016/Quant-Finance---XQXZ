...
# 小盘： 中证500（000905）/中证1000（000852）/中证2000（932000）/创业板（399006）/科创50（000688）/创业200（399019）
df_big = pd.read_csv(r'd:\北京财兴智安实习\轮动\大小盘风格轮动\sh000903.csv', encoding='gbk', parse_dates=['candle_end_time'])
df_small = pd.read_csv(r'd:\北京财兴智安实习\轮动\大小盘风格轮动\sh000905.csv', encoding='gbk', parse_dates=['candle_end_time'])
# df_small['candle_end_time'] = pd.to_datetime(df_small['candle_end_time'])
# print(df_small)
# exit()
# 设置参数
trade_rate = 1 / 10000  # 场内基金万分之0.6，买卖手续费相同，无印花税
momentum_days = 23  # 计算多少天的动量
...
# df = df[df['candle_end_time'] >= '2024-01-01']
# ...existing code...
df = df[(df['candle_end_time'] >= '2010-01-01') & (df['candle_end_time'] <= '2012-08-27')]
# ...existing code...
