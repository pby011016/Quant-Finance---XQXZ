...
N = range(-15, 1)  # 计算多少天的动量
M = range(-15, 1)  # 计算多少天的动量
# print(N)
momentum_days = 20
# exit()
for big_mom_smallest in N:
    for small_mom_smallest in M:
        # 读取数据
        ...
        df.loc[(df['big_mom'] < 0.002*big_mom_smallest ) & (df['small_mom'] < 0.002*small_mom_smallest ), 'style'] = 'empty'
        ...
        print(big_mom_smallest, '   ', small_mom_smallest)
        print(res)
