...
df_big = pd.read_csv(r'd:\北京财兴智安实习\轮动\大小盘风格轮动\sh000905.csv', encoding='gbk', parse_dates=['candle_end_time'])
df_small = pd.read_csv(r'd:\北京财兴智安实习\轮动\大小盘风格轮动\sz399006.csv', encoding='gbk', parse_dates=['candle_end_time'])

# 设置参数
trade_rate = 0.6 / 10000  # 场内基金万分之0.6，买卖手续费相同，无印花税
momentum_days = 11  # 计算多少天的动量
